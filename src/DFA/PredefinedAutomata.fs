...
let dfa_bitwise_minimum =
    let start = State<_, _>("bm:Start", true, true)
    let q_1 = State<_, _>("bm:q_1", false, false)
    start.AddTransition [ '0'; '0'; '0' ] start
    start.AddTransition [ '0'; '1'; '1' ] q_1
    start.AddTransition [ '1'; '0'; '1' ] q_1
    start.AddTransition [ '1'; '1'; '0' ] q_1
    start.AddTransition [ '0'; '1'; '0' ] start
    start.AddTransition [ '1'; '0'; '0' ] start
    start.AddTransition [ '0'; '0'; '1' ] q_1
    start.AddTransition [ '1'; '1'; '1' ] start
    q_1.AddTransition [ '0'; '0'; '0' ] q_1
    q_1.AddTransition [ '0'; '0'; '1' ] q_1
    q_1.AddTransition [ '0'; '1'; '0' ] q_1
    q_1.AddTransition [ '0'; '1'; '1' ] q_1
